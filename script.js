document.addEventListener("DOMContentLoaded", function () {
                ...
                <div class="post-header flex items-center justify-between mb-2">
                    <div class="flex items-center">
                        ...
                        <div class="post-user ml-2 flex-grow">
                            <h2 class="font-extrabold">Howard<span class="verified">✔</span></h2>
                            <p class="text-gray-400 text-sm">@darthvader</p>
    ...
    function closeModal() {
        ...
        setTimeout(() => {
            modal.removeAttribute('aria-hidden'); // Remove o atributo 'aria-hidden' para tornar o modal acessível
        }, 300); // Ajuste o tempo conforme necessário para coincidir com a transição CSS do modal
    
        // Remove a classe 'overflow-y-auto' do corpo para desbloquear o scroll
    ...
    const renderPosts = () => {
        ...
        posts.forEach(post => {
            ...
            postElement.innerHTML = `
                <div class="post-header flex items-center justify-between mb-2">
                    <div class="flex items-center">
                        <img src="https://static.wikia.nocookie.net/marvelcinematicuniverse/images/f/fa/Howard_the_Duck_-_What_If_%282%29.jpg" alt="User Avatar" class="rounded-full w-10 h-10 object-cover">
                        <div class="post-user ml-2 flex-grow">
                            <h2 class="font-extrabold">Howard<span class="verified">✔</span></h2>
                            <p class="text-gray-400 text-sm">@darthvader</p>
                            <p class="post-date text-gray-400 text-sm">${new Date(post.date).toLocaleDateString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' })}</p>
